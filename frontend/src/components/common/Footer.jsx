    ...
    <footer className = "absolute bottom-0 bg-theme-bg shadow w-full">
        <div className = "lg:w-[80%] mx-auto p-4 md:py-8">
            <div className = "sm:flex items-center justify-between">
                <Link to = "/dashboard" className = "flex items-center mb-4 sm:mb-0 space-x-3 no-underline">
                 ...
                 <ul className = "flex flex-wrap items-center text-sm font-medium text-white list-none">
                    <li>
                        <Link to = "/about-us" className = " me-4 md:me-6 text-white no-underline hover:text-theme-color"> About Us </Link>
                    </li>
                    <li>
                        <Link to = "/privacy-policy" className = " me-4 md:me-6 text-white no-underline hover:text-theme-color"> Privacy Policy </Link>
                    </li>

                    {/* <li>
                        <Link to="" className=" me-4 md:me-6 text-white no-underline hover:text-theme-color" > Licensing </Link>
                    </li> */}
                                
                    <li>
                        <Link to = "/contact-us" className = " text-white no-underline hover:text-theme-color"> Contact Us </Link>
                    </li>
                </ul>
            </div>
