    ...
    return (
        <div className=" overflow-auto px-7 py-4 w-full bg-theme-bg text-white rounded-2xl ">
            ...
            <div className=" overflow-auto px-4 bg-theme-bg2 rounded-2xl  border border-border-info-color">
                ...
                <button
                    className="mb-4 px-4 py-2 bg-theme-color text-white rounded-lg hover:bg-theme-color-dark transition"
                    onClick={() => navigate("/user-profile/profile")} // Navigate to profile page
                >
                    Go back to Profile
                </button>
            </div>
