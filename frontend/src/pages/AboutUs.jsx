        ...
        <>
            ...
            <div className = "text-white flex flex-col gap-20 pt-20 px-6 lg:px-11 ">
                ...
                <div className = "m-auto">
                    ...
                    <div className = " grid  md:grid-cols-3 sm:grid-cols-2 gap-5 max-w-[1500px]">
                        {/* dev component */}
                        ...
                        >
                            <div className = "rounded-[20px] overflow-hidden flex-grow">
                                <img
                                    className = "rounded-[20px] hover:scale-105 transition-all duration-300 w-full h-90 object-cover"
                                    src = {src}
                                    alt = "creatorimg"
                                />
                            </div>
                            
                            <div className = "flex-grow flex flex flex-col justify-between">
                ...
                <div className = "max-w-[1500px] m-auto">
                    <div className = "mb-10 text-center">
                        <span className = "text-lg tracking-[5px] uppercase text-theme-color font-semibold"> Process </span>
                        <h2 className = "mt-2 text-4xl font-medium">
                            Create And Sell{" "}
